...
def setup_admin_role():
    ...
    dependent_read_only = [
        "Account Category", "Activity Type", "Additional Salary", "Address",
        ...
        "Delivery Note", "Delivery Trip", "Email Account", "Employee Advance",
        ...
        "Opportunity Type", "Overtime Type", "POS Closing Entry", "POS Invoice",
        "POS Profile", "Payment Order", "Payment Request", "Payment Term",
        "Payment Terms Template", "Payroll Entry", "Payroll Period",
        ...
        "Role", "Role Profile", "Salary Component", "Salary Structure",
        "Salary Withholding", "Sales Partner", "Sales Person", "Sales Stage",
        "Sales Taxes and Charges Template", "Salutation",
        "Serial and Batch Bundle", "Shift Type", "Shipping Rule", "Skill",
    ...
    # 4. Create Workspace (desk landing icon for this role)
    ...
    if not frappe.db.exists("Workspace", workspace_name):
        action_shortcuts = [
            ...
            {"label": "New Purchase Invoice", "type": "DocType", "link_to": "Purchase Invoice", "icon": "credit-card"},
            ...
            {"label": "New Project", "type": "DocType", "link_to": "Project", "icon": "folder-plus"},
            {"label": "New Material Request", "type": "DocType", "link_to": "Material Request", "icon": "package"},
            {"label": "New Stock Entry", "type": "DocType", "link_to": "Stock Entry", "icon": "package"},
            {"label": "Manage Employees", "type": "DocType", "link_to": "Employee", "icon": "users"},
            {"label": "Manage Users", "type": "DocType", "link_to": "User", "icon": "user"},
        ]
        report_shortcuts = [
        ...
        content_blocks = [{"id": "wsAdminHead1", "type": "header", "data": {"text": "Admin Actions", "level": 2}}]
        content_blocks += [
            {"id": f"wsAdminAct{i}", "type": "shortcut", "data": {"shortcut_name": s["label"], "col": 3}}
            for i, s in enumerate(action_shortcuts)
        ]
        content_blocks.append({"id": "wsAdminHead2", "type": "header", "data": {"text": "Reports", "level": 2}})
        content_blocks += [
            {"id": f"wsAdminRpt{i}", "type": "shortcut", "data": {"shortcut_name": s["label"], "col": 3}}
